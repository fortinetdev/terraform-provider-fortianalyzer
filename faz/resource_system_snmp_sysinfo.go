...
func flattenSystemSnmpSysinfoFortianalyzerLegacySysoid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectSystemSnmpSysinfo(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fortianalyzer_legacy_sysoid", flattenSystemSnmpSysinfoFortianalyzerLegacySysoid(o["fortianalyzer-legacy-sysoid"], d, "fortianalyzer_legacy_sysoid")); err != nil {
		if vv, ok := fortiAPIPatch(o["fortianalyzer-legacy-sysoid"], "SystemSnmpSysinfo-FortianalyzerLegacySysoid"); ok {
			if err = d.Set("fortianalyzer_legacy_sysoid", vv); err != nil {
				return fmt.Errorf("Error reading fortianalyzer_legacy_sysoid: %v", err)
			}
		} else {
			return fmt.Errorf("Error reading fortianalyzer_legacy_sysoid: %v", err)
		}
...
func expandSystemSnmpSysinfoFortianalyzerLegacySysoid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectSystemSnmpSysinfo(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fortianalyzer_legacy_sysoid"); ok || d.HasChange("fortianalyzer_legacy_sysoid") {
		...
		if err != nil {
			...
			obj["fortianalyzer-legacy-sysoid"] = t
		}
	}
