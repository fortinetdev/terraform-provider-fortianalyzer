...
page_title: "FortiAnalyzer: fortianalyzer_system_locallog_memory_filter"
description: |-
...
```hcl
resource "fortianalyzer_system_locallog_memory_filter" "trname" {
  devcfg     = "enable"
  devops     = "enable"
  diskquota  = "enable"
  dvm        = "enable"
...
$ terraform import fortianalyzer_system_locallog_memory_filter.labelname SystemLocallogMemoryFilter
