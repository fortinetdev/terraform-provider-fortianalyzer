...
page_title: "FortiAnalyzer: fortianalyzer_system_locallog_disk_filter"
description: |-
...
$ terraform import fortianalyzer_system_locallog_disk_filter.labelname SystemLocallogDiskFilter
