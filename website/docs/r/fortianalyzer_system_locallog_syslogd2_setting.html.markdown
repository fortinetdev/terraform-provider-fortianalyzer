...
page_title: "FortiAnalyzer: fortianalyzer_system_locallog_syslogd2_setting"
description: |-
  Settings for remote syslog server.
---

# fortianalyzer_system_locallog_syslogd2_setting
Settings for remote syslog server.
...
$ terraform import fortianalyzer_system_locallog_syslogd2_setting.labelname SystemLocallogSyslogd2Setting
