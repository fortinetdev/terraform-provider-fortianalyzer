...
page_title: "FortiAnalyzer: fortianalyzer_system_log_settings_rollingregular"
description: |-
...
$ terraform import fortianalyzer_system_log_settings_rollingregular.labelname SystemLogSettingsRollingRegular
