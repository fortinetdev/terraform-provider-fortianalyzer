...
page_title: "FortiAnalyzer: fortianalyzer_system_locallog_syslogd_filter"
description: |-
  Filter for syslog logging.
---

# fortianalyzer_system_locallog_syslogd_filter
Filter for syslog logging.

## Example Usage

```hcl
resource "fortianalyzer_system_locallog_syslogd_filter" "trname" {
  devcfg     = "enable"
  devops     = "enable"
  diskquota  = "enable"
  dvm        = "enable"
...
$ terraform import fortianalyzer_system_locallog_syslogd_filter.labelname SystemLocallogSyslogdFilter
